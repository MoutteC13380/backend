...
if ((isset($_GET['idContract'])) || (isset($_GET['idBooking']))) {
    ...
    if ($counter > 0) {
        ...
        $resultPictures = $pictures_array;
    }
    $result = [$resultContract, $resultVideos, $resultPictures];
} else {
    ...
    if ($counter > 0) {
        ...
        while ($row = $contracts->fetch()) {
            ...
            $contract_item = [
                ...
                "urlCustomerForthInventory" => $urlCustomerForthInventory,
                "urlPartnerForthInventory" => $urlPartnerForthInventory,
                "urlPartnerBackInventory" => $urlPartnerBackInventory,
