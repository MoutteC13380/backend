...
class Teammate 
{
    ...
    public function searchTeammatesByStatus() 
    {
        $query = "
        SELECT *
        FROM "
        . $this->table . " 
        WHERE statusTeammate = :statusTeammate";
        $stmt = $this->conn->prepare($query);

        $params = ["statusTeammate" => htmlspecialchars(strip_tags($this->statusTeammate))];
    ...
    public function searchActiveTeammates() 
    {
        $query = "
        SELECT *
        FROM "
        . $this->table . " 
        WHERE statusTeammate =! 'inactif'";
        $stmt = $this->conn->prepare($query);
    ...
    public function updateTeammateStatus() 
    {
        $query = "
            UPDATE "
            . $this->table .
